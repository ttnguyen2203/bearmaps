...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            GraphDB.Node temp = g.makeNode(attributes.getValue("id"), attributes.getValue("lon"),
            ...
            store.add(attributes.getValue("ref"));

            long id = Long.valueOf(attributes.getValue("ref"));
            previous = g.nodeAt(id);
            ...
            if (k.equals("maxspeed")) {
                ...
                //TODO do stuff here later for bonus
            }
            ...
            previous.extraInfo.put(attributes.getValue("k"), attributes.getValue("v"));
            g.search.add(attributes.getValue("v"), previous.id);
        }
    }
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("way")) {
            ...
            if (validWay) {
                long a = Long.valueOf(store.removeFirst());
                while (!store.isEmpty()) {
                    long b = Long.valueOf(store.removeFirst());
                    g.addEdge(a, b);
                    a = b;
                }
                g.way += 1;
